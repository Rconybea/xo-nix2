{
  ...
  # xo dependencies
  xo-cmake, xo-pyutil, xo-reactor, xo-pyreflect, xo-pyprintjson,
...
stdenv.mkDerivation (finalattrs:
  {
    ...
    src = (fetchGit {
      url = "https://github.com/rconybea/xo-pyreactor";
      version = "1.0";
      #ref = "ex1";
    ...
    propagatedBuildInputs = [ xo-reactor xo-pyreflect xo-pyprintjson ];
  })
