{
  ...
  stdenv, cmake, catch2, libwebsockets, jsoncpp, # ... other deps here
...
stdenv.mkDerivation (finalattrs:
  {
    ...
    src = (fetchGit {
      url = "https://github.com/rconybea/xo-websock";
      version = "1.0";
      #ref = "ex1";
    ...
    propagatedBuildInputs = [ xo-reactor
                              libwebsockets jsoncpp ];
  })
